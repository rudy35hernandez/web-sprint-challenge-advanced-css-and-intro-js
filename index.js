...
function getBio(array, index) {
    return array[index].bio;
}

console.log(getName(artists, 0));
console.log(getBio(artists, 2));
...
/*second answer */
  ...
  function get20s(array, year){
    ...
    let overNineteenHundred = artists.filter(function (e) {
        return e.years > year;
    })
    return overNineteenHundred;
    };
...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, 20, 'Rudy Hernandez', 'Web Design', 'Mexican-American', 'The master of Javascript. He took Javascript to heights not even the bravest mountain climbers dared to reach.'));
...
function lotsOfArt(array){
 ...
 // Answer is done!!!!!! Answer 1.
 
 function lotsOfArt(array){
 
 let overOneHundred = artists.filter(function (e) {
     return e.paintings > 99;
 })
 return overOneHundred;
 };
 console.log(lotsOfArt(artists));
